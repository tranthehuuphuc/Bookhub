    ...
    <h1 class="visuallyhidden">BookHub</h1>
        ...
        <nav class="navbar">
            ...
            <div class="link-container">
                ...
                <a class="globalnav-item-show" href="./AccountReceipts.html">Đơn hàng</a>
                <a class="globalnav-item-show" href="./AccountCart.html">Mục đã lưu</a>
                <a class="globalnav-item-show" href="./AccountSettings.html">Tài khoản</a>
                <a class="globalnav-item-show" href="./AccountAssets/join.png">Đăng xuất</a>
