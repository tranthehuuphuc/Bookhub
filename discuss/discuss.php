    ...
    <h1 class="visuallyhidden">BookHub</h1>
        ...
        <nav class="navbar">
            ...
            <div class="link-container">
                ...
                <a class="globalnav-item-show" href="../account/orders.html">Đơn hàng</a>
                <a class="globalnav-item-show" href="../account/saves.html">Mục đã lưu</a>
                <a class="globalnav-item-show" href="../account/profile.html">Tài khoản</a>
